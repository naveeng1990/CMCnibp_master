...
# 51 "SSD1306.c"
        ...
        if (vccstate == 0x1) { SSD1306_Command(0x10); }
        ...
        if (vccstate == 0x1) { SSD1306_Command(0x9F); }
        else { SSD1306_Command(0xCF); }
        SSD1306_Command(0xD9);
        if (vccstate == 0x1) { SSD1306_Command(0x22); }
    ...
    for (i = 0; i < 64 / 8; i++)
    {
        ...
        for(j = 0; j < 8; j++)
        {
            ...
            I2C2_Write((0x3C << 1));
            I2C2_Write(0x40);
            for (k = 0; k < 128 / 8; k++) { I2C2_Write(0); }
            I2C2_Stop();
        }
    }
}

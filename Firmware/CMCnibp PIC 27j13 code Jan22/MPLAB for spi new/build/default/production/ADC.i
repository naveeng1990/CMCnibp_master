...
unsigned char ADC_BatteryLevel()
{
    ...
    if(adcConv > (float)((8.5 - 7.5)*3/4 + 7.5)) {return 4;}
    else if(adcConv > (float)((8.5 - 7.5)*2/4 + 7.5)) {return 3;}
    else if(adcConv > (float)((8.5 - 7.5)/4 + 7.5)) {return 2;}
    else if(adcConv > 7.5) {return 1;}
    else {return 0;}
}

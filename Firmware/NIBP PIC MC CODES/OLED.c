...
void OLED_PrintInt(uint16_t value, uint8_t padding)
{
    ...
    for (i = 5; i > 0; i--)
    {
        ...
        if (v == 0 && padding && den)
        {
            if (padding >= i) { OLED_WriteDigit((m_flags & FLAG_PAD_ZERO) ? 0 : -1); }
            continue;
        }
        padding = 0;
        OLED_WriteDigit(v);
    ...
    if (m_font == FONT_SIZE_SMALL)
    {
        ...
        if (c > 0x20 && c < 0x7f)
        {
            ...
            for (i = 0; i < 5; i++)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(font5x8[c][i]);
            }
            I2C2_Write(0);
        }
        else
        {
            for (i = (m_flags & FLAG_PIXEL_DOUBLE_H) ? 11 : 6; i > 0; i--) { I2C2_Write(0); }
        }
        I2C2_Stop();
        ...
        if (c > 0x20 && c < 0x7f) {
            ...
            for (i = 0; i <= 14; i += 2)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(font8x16_terminal[c][i]);
            }
            I2C2_Stop();
        ...
        else
        {
            ...
            I2C2_Write(SSD1306_I2C_ADDRESS);
            I2C2_Write(0x40);
            for (i = (m_flags & FLAG_PIXEL_DOUBLE_H) ? 16 : 8; i > 0; i--) { I2C2_Write(0); }
            I2C2_Stop();
    ...
    else if (m_font == FONT_SIZE_LARGE)
    {
        if (n <= 9)
        {
            ...
            for (i = 0; i < 16; i ++)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(digits16x16[n][i]);
            }
            I2C2_Stop();
        ...
        else
        {
            ...
            for(i = (m_flags & FLAG_PIXEL_DOUBLE_H) ? 32 : 16; i > 0; i--) { I2C2_Write(0); }
            I2C2_Stop();
    ...
    else
    {
        if (n <= 9)
        {
            ...
            for (i = 0; i < 16; i ++)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(digits16x24[n][i * 3]);
            }
            I2C2_Stop();
            ...
            for (i = 0; i < 16; i ++)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(digits16x24[n][i * 3 + 1]);
            }
            I2C2_Stop();
            ...
            for (i = 0; i < 16; i ++)
            {
                ...
                if (m_flags & FLAG_PIXEL_DOUBLE_H) I2C2_Write(digits16x24[n][i * 3 + 2]);
            }
            I2C2_Stop();
        }
        else
